	...
	<article id="${produto.id}" itemscope>
		<header class="cabecalhoProduto container">
			...
			<div class="cabecalhoProduto-tituloEAutor">
				...
				<span class="cabecalhoProduto-nomeAutor"> </span>
			</div>
			...
			<ul class="adicionarAoCarrinho-listaOfertas">
				...
				<c:forEach items="${produto.precos}" var="preco">
					<li class="adicionarAoCarrinho-oferta" itemprop="offers" itemscope
						itemtype="http://schema.org/Offer"><label
						class="adicionarAoCarrinho-infosDaOferta"
						for="product-variant-970167977"> <span
							class="adicionarAoCarrinho-tipoDaOferta" role="presentation"
							itemprop="category" itemscope itemtype="http://schema.org/Ebook">

								<span class="adicionarAoCarrinho-tipoDaOferta-nome">
									${preco.tipo} </span> <small
								class="adicionarAoCarrinho-tipoDaOferta-detalhe"> (.pdf,
									.epub e .mobi) </small>

						</span>
							<p class="adicionarAoCarrinho-preco">
								<small class="adicionarAoCarrinho-preco-promocao"> <del
										class="adicionarAoCarrinho-preco-promocao-valor">R$
										00,00</del> por
								</small> <span class="adicionarAoCarrinho-preco-valor" itemprop="price">
									${preco.valor} </span>
						...
						<button class="adicionarAoCarrinho-botaoComprar" type="submit"
							...
							title="Compre o ${preco.tipo}">Comprar</button>
				</c:forEach>
				</li>
			</ul>
		</form:form>
		...
		<section class="conteudoDoLivro infoSection" itemprop="description">
			...
			<p itemprop="description" class="infoSection-texto">${produto.descricao}</p>
		...
		<section class="infosAdicionaisDoLivro infoSection">
			...
			<dl class="infosAdicionaisDoLivro-info">
				...
				<dt class="infosAdicionaisDoLivro-info-titulo">ISBN:</dt>
				<dd class="infosAdicionaisDoLivro-info-valor" itemprop="isbn">
					978-85-66250-46-6</dd>
			...
			<div class="infosAdicionaisDoLivro-links" role="presentation">
				<a class="infosAdicionaisDoLivro-button" href='/submissao-errata'>
					Submeter errata </a> <a class="infosAdicionaisDoLivro-button"
					rel="nofollow" href='/link-para-discussões'
					title="Ir para formulário de errata"> Grupo de discussões </a>
		...
		<section class="compartilhar infoSection">
			...
			<a class="compartilhar-facebook"
				href="http://www.facebook.com/sharer/sharer.php?u=http://www.casadocodigo.com.br/products/livro-java8"
				...
				href="https://twitter.com/home?status=Java 8 Pr&#225;tico na @casadocodigo http://www.casadocodigo.com.br/products/livro-java8"
