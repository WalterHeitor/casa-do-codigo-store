...
@ActiveProfiles("test")
public class ProdutosControllersTest {
	...
	/*
	 * make a http request, test if redirect exists and test if it's home.jsp,
	 * also test if attribute produtos exists
	 */
	@Test
	public void deveRetornarParaAHomeComOsLivros() throws Exception {
